...
def _write_env(*, api_key: str, name: str, models: dict[str, str]) -> None:
    ...
    def _quote(v: str) -> str:
        # Wrap in double quotes so python-dotenv reads the value literally.
        # Escape any embedded double quotes to avoid breaking the quoting.
        return '"' + v.replace('"', '\\"') + '"'
    ...
    lines: list[str] = [
        ...
        "\n",
        f"OPENROUTER_API_KEY={_quote(api_key)}\n",
        f"MACROA_USER_NAME={_quote(name)}\n",
    ]
